...
applies_when: producing an editor cut-map / edit-map handoff for a human editor
---
...
Load it as calibration BEFORE producing an **editor cut map** — the deliverable that hands a long talking-head / interview / VSL recording to a human editor to *tighten* (not auto-cut, not just transcribe).
